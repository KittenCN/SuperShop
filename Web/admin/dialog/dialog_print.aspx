...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <tr>
      <td valign="top">支付方式：<%=new BLL.payment().GetTitle(model.payment_id) %></td>
      <td>收货地址：<%=model.area%> <%=model.address%><br /></td>
    </tr>
    <tr>
      <td>配送小区：<%=new BLL.express().GetTitle(model.express_id)%></td>
