...
namespace Web.admin.settings
{
    public partial class url_rewrite_list : Web.UI.ManagePage
    {
        ...
        {
            this.channel = AXRequest.GetQueryString("channel");
            this.type = AXRequest.GetQueryString("type");
        ...
        {
            ChkAdminLevel("site_url_rewrite", AXEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(AXEnums.ActionEnum.Delete.ToString(), "删除URL配置信息"); //记录日志
