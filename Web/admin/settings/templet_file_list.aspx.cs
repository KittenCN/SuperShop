...
namespace Web.admin.settings
{
    public partial class templet_file_list : Web.UI.ManagePage
    {
        ...
        {
            skinName = AXRequest.GetQueryString("skin");
        ...
        {
            ChkAdminLevel("app_templet_list", AXEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(AXEnums.ActionEnum.Delete.ToString(), "删除模板文件，模板:" + this.skinName);//记录日志
