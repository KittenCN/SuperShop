<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.UI.Page.userorder_show"
...
<script runat="server">
    override protected void OnInit(EventArgs e)
    {
        ...
        */
        ...
        templateBuilder.Append("</dd>\r\n        </dl>\r\n      </div>\r\n              \r\n      <div class=\"line10\"></div>\r\n      ");
        templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"5\" class=\"ftable\">\r\n        ");
        templateBuilder.Append("<tr>\r\n<th width=\"64\"></th>\r\n");
        templateBuilder.Append("<th width=\"\">产品名称</th>\r\n");
        templateBuilder.Append("<th width=\"\">条形码</td>\r\n          ");
        templateBuilder.Append("<th width=\"\">订单编号</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">明细编号</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">产品编号</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">产品类别</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">型号</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">规格</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">单位</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">体积</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">重量</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">订货数量</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">明细备注</th>\r\n          ");
        templateBuilder.Append("<th width=\"\">总价</th>\r\n        </tr>\r\n        ");
        DataTable dt = (new BLL.order_goods().GetList(model.id)).Tables[0];
        if (dt.Rows.Count > 0)
        {
            foreach (DataRow row in dt.Rows)
            {
                templateBuilder.Append("\r\n<tr>\r\n<td><a target=\"_blank\" href=\"" + linkurl("goods_show", Utils.ObjectToStr(row["goods_id"])) + "\"><img src=\"" + get_article_img_url(Utils.ObjToInt(row["goods_id"], 0)).ToString() + "\" class=\"img\" /></a></td>\r\n          ");
                templateBuilder.Append("<td align=\"left\"><a target=\"_blank\" href=\"" + linkurl("goods_show", Utils.ObjectToStr(row["goods_id"])) + "\">" + Utils.ObjectToStr(row["name"]) + "</a></td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["barcode"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["order_no"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["goods_no"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["article_no"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["category"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["xinghao"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["spec"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["units"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["tiji"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["weights"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["quantity"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\">" + (Utils.ObjectToStr(row["remark"])) + "</td>\r\n          ");
                templateBuilder.Append("<td align=\"center\"><font color=\"#FF0000\" size=\"2\">￥" + ((Utils.ObjToDecimal(row["real_price"], 0)) * (Utils.ObjToDecimal(row["quantity"],0))).ToString() + "</font></td>\r\n        </tr>\r\n        ");
            }	//end for if
        }
        else
        {
