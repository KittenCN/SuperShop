...
namespace DAL
{
    ...
    public partial class users
    {
        ...
        public int Add(Model.users model)
        {
            ...
            strSql.Append("group_id,express_id,user_name,password,salt,email,nick_name,avatar,sex,birthday,telphone,mobile,qq,address,safe_question,safe_answer,amount,point,exp,status,reg_time,reg_ip)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,group_id,express_id,user_name,password,salt,email,nick_name,avatar,sex,birthday,telphone,mobile,qq,address,safe_question,safe_answer,amount,point,exp,status,reg_time,reg_ip from " + databaseprefix + "users ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
