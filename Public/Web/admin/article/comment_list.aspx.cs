...
namespace Web.admin.article
{
    public partial class comment_list : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("channel_" + this.channel_name + "_comment", AXEnums.ActionEnum.Audit.ToString()); //检查权限
            BLL.article_comment bll = new BLL.article_comment();
            ...
            AddAdminLog(AXEnums.ActionEnum.Audit.ToString(), "审核" + this.channel_name + "频道评论信息"); //记录日志
        ...
        {
            ChkAdminLevel("channel_" + this.channel_name + "_comment", AXEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.article_comment bll = new BLL.article_comment();
            for (int i = 0; i < rptList.Items.Count; i++)
            ...
            AddAdminLog(AXEnums.ActionEnum.Delete.ToString(), "删除" + this.channel_name + "频道评论成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
