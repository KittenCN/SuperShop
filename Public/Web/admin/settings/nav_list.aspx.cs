...
namespace Web.admin.settings
{
    public partial class nav_list : Web.UI.ManagePage
    {
        ...
        private void RptBind()
        {
            ...
            DataTable dt = bll.GetList(0, AXEnums.NavigationEnum.System.ToString());
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(AXEnums.ActionEnum.Edit.ToString(), "保存导航排序"); //记录日志
        ...
        {
            ChkAdminLevel("app_navigation_list", AXEnums.ActionEnum.Delete.ToString()); //检查权限
            BLL.navigation bll = new BLL.navigation();
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                int id = Convert.ToInt32(((HiddenField)rptList.Items[i].FindControl("hidId")).Value);
            ...
            AddAdminLog(AXEnums.ActionEnum.Delete.ToString(), "删除导航信息"); //记录日志
