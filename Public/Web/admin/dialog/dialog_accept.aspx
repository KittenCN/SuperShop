<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_accept.aspx.cs" Inherits="Web.admin.dialog.dialog_accept" %>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        if ($("#txtAddress").val() == "") {
            W.$.dialog.alert('请填写详细的收货地址！', function () { $("#txtAddress").focus(); }, api);
            return false;
        }
