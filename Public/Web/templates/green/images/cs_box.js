...
var cs_box = {
	...
	qqfn : function(json){
		...
		var link = 'http://www.sina.com.cn';
		this.btn.onclick = function(){
			window.open(link,'_blank','height=400, width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		};
	},
	cs_close : function(){
