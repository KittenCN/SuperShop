...
namespace Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[AXKeys.SESSION_USER_INFO] = null;
                //清除Cookies
                Utils.WriteCookie(AXKeys.COOKIE_USER_NAME_REMEMBER, "AoXiang", -43200);
                Utils.WriteCookie(AXKeys.COOKIE_USER_PWD_REMEMBER, "AoXiang", -43200);
                Utils.WriteCookie("UserName", "AoXiang", -1);
                Utils.WriteCookie("Password", "AoXiang", -1);
                //自动登录,跳转URL
